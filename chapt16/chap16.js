...
function askQuestion(questionNumber) {
    ...
    switch (questionNumber) {
        ...
        case 2:
            ...
            break;
        case 3:
            question.innerHTML = "Kill Gizmo , or let Gizmo live.";
            break;
...
function continueStory(answerNumber) {
    switch (answerNumber) {
        ...
        case 3:
            if (answers[3] === "KILL GIZMO") {
                story.innerHTML = document.getElementById("answer101").innerHTML;
                theEnd();
            } else if (answers[3] === "LET GIZMO LIVE") {
                story.innerHTML = document.getElementById("answer100").innerHTML;
                theEnd();
            } else {
